...
const generateFixtures = (schemaFaker, schemas, params) => {
  const {type} = params;
  ...
  return recipe.map(r => generateFixture(schemaFaker, schema, r));
};

const generateFixture = (schemaFaker, schema, recipe) => {
